import './Footer.css';
import phoneImage from '../../image/svg/phone.svg';
import mailImage from '../../image/svg/mail.svg';
import skypeImage from '../../image/svg/skype.svg';
import geolocationImage from '../../image/svg/geolocation.svg';
import youtubeIcon from '../../image/svg/youtube__icon.svg';
import linkedinIcon from '../../image/svg/linkedin__icon.svg';
import googlePlusIcon from '../../image/svg/g+.svg';
import facebookIcon from '../../image/svg/facebook.svg';
import twitterIcon from '../../image/svg/twitter__icon.svg';

const Footer = () => {
  return (
    <footer className='footer'>
      <div className='footer__container'>
        <address className="footer__container__address">
            <h2 className='footer__title'>Свяжитесь с нами</h2>
            <ul className="footer__container-contacts">
              <li className="footer__container-contacts__item">
                <img className='phone__icon' src={phoneImage} alt="phone icon" />
                <a href='tel:88000000000'>8(800)000 00 00</a>
              </li>
              <li className="footer__container-contacts__item">
                <img className='mail__icon' 
                src={mailImage} alt="mail icon" />
                <a href='mailto:inbox@mail.ru'>inbox@mail.ru</a>
              </li>
              <li className="footer__container-contacts__item">
                <img className='skype__icon' 
                src={skypeImage} alt="skype icon" />
                <a href='skype:tu.train.tickets'>tu.train.tickets</a>
              </li>
              <li className="footer__container-contacts__item">
                <img className='geolocation__icon' 
                src={geolocationImage} alt="location icon" />
                <p>г. Москва <br/>ул.Московская 27-35 555 555</p>
              </li>
            </ul>
        </address>
        <div className="footer__container-subscribe">
          ...
          <form >
            ...
            <div className='footer__btn-subscribe-input-container'>
              <input type="email" required placeholder='e-mail'/>
              <button className='footer__btn-subscribe-submit'  type='submit'>ОТПРАВИТЬ</button>
            </div>
          </form>
          <h2 className='footer__title'>Подписывайтесь на нас</h2>
          <ul className="footer__container-subscribe__container">
            <li className="footer__container-subscribe__container-item">
              <a href="https://www.youtube.com">
              <svg className='footer__link-icon' width="38" height="30" viewBox="0 0 38 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className="footer__container-subscribe__container-item">
              <a href="https://www.linkedin.com">
                <svg className='footer__link-icon' width="32" height="30" viewBox="0 0 32 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M6.62827 29.9999C4.4339 29.9999 2.25446 29.9999 0.045166 29.9999C0.045166 22.9839 0.045166 15.9829 0.045166 8.93701C2.23953 8.93701 4.40404 8.93701 6.62827 8.93701C6.62827 15.9381 6.62827 22.9392 6.62827 29.9999Z" fill="#E5E5E5"/>
            ...
            <li className="footer__container-subscribe__container-item">
              <a href="https://www.google.ru">
                <svg className='footer__link-icon' width="47" height="30" viewBox="0 0 47 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className="footer__container-subscribe__container-item">
              <a href="https://www.facebook.com">
                <svg className='footer__link-icon' width="14" height="30" viewBox="0 0 14 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className="footer__container-subscribe__container-item">
              <a href="https://twitter.com">
                <svg className='footer__link-icon' width="37" height="30" viewBox="0 0 37 30" fill="none" xmlns="http://www.w3.org/2000/svg">
